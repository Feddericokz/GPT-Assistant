...
public class GPT4SeniorDevProcessSelection extends GPTProcessSelection {

    public static final String GPT4_SENIOR_DEV_MODEL_VERSION = "GPT4-SeniorDev";

    public GPT4SeniorDevProcessSelection() {
        super();
    }

    @Override
    public String getModelVersion() {
        return GPT4_SENIOR_DEV_MODEL_VERSION;
    }
