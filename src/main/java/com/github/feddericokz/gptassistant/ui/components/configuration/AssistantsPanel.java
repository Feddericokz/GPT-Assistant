...
import com.github.feddericokz.gptassistant.ui.components.contextselector.CollapsiblePanel;
...
public class AssistantsPanel extends JPanel {
    ...
    private static final String[] MODEL_OPTIONS = {"gpt-4-0125-preview", "gpt-4-turbo-preview", "gpt-4-1106-preview",
            ...
            "gpt-3.5-turbo", "gpt-3.5-turbo-1106", "gpt-3.5-turbo-instruct", "gpt-3.5-turbo-16k", "gpt-3.5-turbo-0613",
